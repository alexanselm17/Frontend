...
class MaterialTheme {
  ...
  static MaterialScheme lightMediumContrastScheme() {
    return MaterialScheme(
      ...
      surfaceTint: const Color(0xff406836),
      onPrimary: const Color(0xffffffff),
      primaryContainer: const Color(0xff557f4a),
      onPrimaryContainer: const Color(0xffffffff),
      secondary: const Color(0xff394733),
      onSecondary: const Color(0xffffffff),
      secondaryContainer: const Color(0xff6a7963),
      onSecondaryContainer: const Color(0xffffffff),
      tertiary: const Color(0xff19494c),
      onTertiary: const Color(0xffffffff),
      tertiaryContainer: const Color(0xff4f7c7f),
      ...
      onBackground: const Color(0xff191d17),
      surface: const Color(0xfff8fbf1),
      onSurface: const Color(0xff191d17),
      surfaceVariant: const Color(0xffdfe4d7),
      onSurfaceVariant: const Color(0xff3f453b),
      outline: const Color(0xff5b6157),
      outlineVariant: const Color(0xff777d72),
      shadow: const Color(0xff000000),
      scrim: const Color(0xff000000),
      inverseSurface: const Color(0xff2e322b),
      inverseOnSurface: const Color(0xffeff2e8),
      inversePrimary: const Color(0xffa5d395),
      primaryFixed: const Color(0xff557f4a),
      onPrimaryFixed: const Color(0xffffffff),
      primaryFixedDim: const Color(0xff3d6633),
      onPrimaryFixedVariant: const Color(0xffffffff),
      secondaryFixed: const Color(0xff6a7963),
      onSecondaryFixed: const Color(0xffffffff),
      secondaryFixedDim: const Color(0xff51604b),
      onSecondaryFixedVariant: const Color(0xffffffff),
      tertiaryFixed: const Color(0xff4f7c7f),
      onTertiaryFixed: const Color(0xffffffff),
      tertiaryFixedDim: const Color(0xff366366),
      onTertiaryFixedVariant: const Color(0xffffffff),
      surfaceDim: const Color(0xffd8dbd2),
      surfaceBright: const Color(0xfff8fbf1),
      surfaceContainerLowest: const Color(0xffffffff),
      surfaceContainerLow: const Color(0xfff2f5eb),
      surfaceContainer: const Color(0xffecefe5),
      surfaceContainerHigh: const Color(0xffe6e9e0),
      surfaceContainerHighest: const Color(0xffe1e4da),
    );
  }
